...
<head>
    ...
    <title>Horror Books | Nepal Reads</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/home.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/horror.css?v=1">
</head>
<body>
    <jsp:include page="header.jsp" /> 

    <main class="genre-container">
        <h2 class="genre-title">Horror Collection</h2>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <div style="grid-column: 1 / -1; text-align: center; padding: 60px; color: #888;">
                        ...
                        <p>No spooky tales available right now. Check back soon!</p>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
